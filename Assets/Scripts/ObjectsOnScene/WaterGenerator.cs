...
public class WaterGenerator : MonoBehaviour
{
    ...
    IEnumerator CreateWater()
    {
        ...
        for(int x = 0; x < 300 ; x++)
        {
            ...
            {
                waterListUniversal.Add((GameObject)Instantiate(Waterplane, new Vector3(waterPositionX, 26, -1500), Quaternion.identity));
            }else
            {
        ...
        {  
            ...
            if (!Physics.Raycast(new Vector3 (waterPositionXCorrect, 1000, waterPositionZCorrect), Vector3.down, out hit, 970))
            {
                ...
                if (!Physics.Raycast(new Vector3 (waterPositionXCorrect, 1000, waterPositionZCorrect), Vector3.down, out hit, 980, waterLayer))
                {
                    ...
                    if (waterListCorrect.Count>10300)
                    {
    ...
    void UpdateWaterPositionEsq()
    {
        ...
        UpdateWaterList();
        UpdateWaterCorrect(waterPositionXUpdateEsq-100,waterPositionZUpdateSaveEsq);
    ...
    void UpdateWaterPositionDir()
    {
        ...
        UpdateWaterList();
        UpdateWaterCorrect(waterPositionXUpdateDir+100,waterPositionZUpdateSaveDir-3000);
    ...
    void UpdateWaterPositionBaix()
    {
        ...
        UpdateWaterList();
        UpdateWaterCorrectZ(waterPositionXUpdateSaveBaix,waterPositionZUpdateBaix-100);
    ...
    void UpdateWaterPositionCima()
    {
        ...
        UpdateWaterList();
        UpdateWaterCorrectZ(waterPositionXUpdateSaveCima-3000,waterPositionZUpdateCima+100);
